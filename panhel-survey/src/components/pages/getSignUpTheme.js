            ...
            variants: [
              ...
              },
              {
                ...
                style: {
                  ccolor: 'white',
                  backgroundColor: brand.pink,
                  backgroundImage: `linear-gradient(to bottom, ${alpha(brand.pink, 0.8)}, ${brand.pink})`,
                  boxShadow: `inset 0 2px 0 ${alpha(brand.pink, 0.2)}, inset 0 -2px 0 ${alpha(brand.pink, 0.4)}`,
                  ...
                  '&:active': {
                    backgroundColor: brand.pink,
                    boxShadow: `inset 0 2.5px 0 ${alpha(brand.pink, 0.4)}`,
                  },
                },
              },
              {
