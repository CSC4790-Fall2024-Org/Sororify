...
import { filledInputClasses, textFieldClasses } from '@mui/material';
...
function SuperAdminSurvey() {
  ...
  adminSurveys.applyTheme(
    {
        ...
        "cssVariables": {
            ...
            "--sjs-border-default": "rgba(0, 0, 128, 0.16)",
  ...
  adminSurveys.onComplete.add(function (sender) {
    // 'sender.data' contains the survey data
    axios.post('http://localhost:5000/api/survey-results', {
        surveyType: 'Admin Survey',  // Unique identifier for DG Survey
  ...
  return (
    <div>
        <Survey model={adminSurveys} />
    </div>
);
    
}

export default SuperAdminSurvey;
